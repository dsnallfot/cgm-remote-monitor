...
// Optional: Create a global configuration object
var appConfig = {
  hideMenu: hideMenu,
...
daytoday.prepareHtml = function daytodayPrepareHtml(sorteddaystoshow) {
  ...
  sorteddaystoshow.forEach(function eachDay(d) {
    $('#daytodaycharts').append($('<table><tr><td><div id="daytodaychart-' + d + '"></div></td><td><div id="daytodaystatchart-' + d + '"></div></td></tr></table>'));
  });
};
...
daytoday.report = function report_daytoday(datastorage, sorteddaystoshow, options) {
  ...
  if (options.insulindistribution && !appConfig.hideMenu) {
