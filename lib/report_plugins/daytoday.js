      ...
      sel.attr('cx', function(d) {
        ...
        .on('mouseover', function(d) {
          if (options.openAps && d.openaps) {
              ...
              // Extract AF and SMB Ratio first before replacing ";" with line breaks
              ...
              let result = `AF: ${afValue} <br>`; // AF is always present
              if (smbRatio) {
              result += `• SMB Ratio: ${smbRatio} <br>`; // If SMB Ratio exists, place it right below AF
              }
              return result + `------------------------------ <br><b>☑️ Oref slutsats:</b>`; // Ensure correct placement
              });
