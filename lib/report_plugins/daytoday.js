      ...
      sel.attr('cx', function(d) {
        ...
        .on('mouseover', function(d) {
          if (options.openAps && d.openaps) {
              ...
              // Ensure "------------------------------ <br> ☑️ Oref slutsats:" appears after the last relevant value
              ...
              let result = `${afValue}`; // AF is always present
              if (smbRatio) {
              result += `${smbRatio}`; // SMB Ratio, if it exists, stays directly below AF
              }
              return result + `<br>------------------------------ <br><b>☑️ Oref slutsats:</b>`; // Ensures correct placement
              });
