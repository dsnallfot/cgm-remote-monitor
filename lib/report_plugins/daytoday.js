...
/*
            // Extract and format the localTimeString in Swedish local time
            var timestamp = d.openaps.suggested.deliverAt;
            ...
            */
            ...
            /*var text = '<b>BG:</b> ' + Math.round(d.openaps.suggested.bg * 0.0555 * 10) / 10 + ' • ' + localTimeString + '<br>• ' + reasonWithLineBreaks +
                (d.openaps.suggested.mealAssist ? ' <b>Meal Assist:</b> ' + d.openaps.suggested.mealAssist : '');
*/
                var text = '<b>BG:</b> ' + Math.round(d.openaps.suggested.bg * 0.0555 * 10) / 10 + '<br> • ' + reasonWithLineBreaks +
                (d.openaps.suggested.mealAssist ? ' <b>Meal Assist:</b> ' + d.openaps.suggested.mealAssist : '');
