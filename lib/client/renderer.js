  ...
  renderer.addTreatmentCircles = function addTreatmentCircles (nowDate) {
    ...
    function treatmentTextTransform (d) {
      if (d.durationType === "indefinite") {
        ...
        //Daniel: Force middle alignment without offset 
        return 'translate(' + (chart().xScale(new Date(d.mills + times.mins(d.duration).msecs)) - chart().xScale(getOrAddDate(d))) / 2 + ',' + 0 + ')';
