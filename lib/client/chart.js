    ...
    if (widthChanged || (chart.prevChartHeight !== chartHeight)) {
      ...
      if (init) {
        ...
        chart.focus.append('line')
          ...
          .attr('stroke', 'red');  // Daniel: Change color to red

        // add a y-axis line that shows the target top bg threshold
        chart.focus.append('line')
          ...
          .style('stroke-dasharray', ('6, 1'))  // Daniel: Almost solid line, small dashes
          .attr('stroke', 'rgba(255, 255, 0, 0.7)');  // Yellow with 70% opacity using rgba

        // add a y-axis line that shows the target bottom bg threshold
        chart.focus.append('line')
          ...
          .style('stroke-dasharray', ('6, 1'))  // Daniel: Solid line, no dashes
          .attr('stroke', 'rgba(255, 0, 0, 0.7)');  // Red with 70% opacity using rgba
