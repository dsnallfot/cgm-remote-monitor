    ...
    function updatePlugins (time) {
      ...
      client.plugins.updateVisualisations(client.sbx);
        ...
        _.each(client.sbx.pluginBase.forecastInfos, function eachInfo(info) {
          ...
          // Change the logic for setting the "checked" property
          ...
          // Toggle the visibility of forecast information based on checkbox state
          if (forecastCheckbox.prop('checked')) {
            // If the checkbox is checked, hide the forecast information
            forecastOption.hide();
          }
          ...
          forecastCheckbox.change(function onChange(event) {
            ...
            // Change how you update the client.settings.showForecast
            if (checked) {
            ...
            // Toggle the visibility of forecast information based on checkbox state
            if (checked) {
              forecastOption.hide(); // Hide the forecast information
            } else {
              forecastOption.show(); // Show the forecast information
            }
          });
