...
_.each(client.sbx.pluginBase.forecastInfos, function eachInfo(info) {
  ...
  if (!forecastCheckbox.prop('checked')) {
    // If the checkbox is unchecked, hide the forecast information
    // Your code to hide forecast information goes here
  }
  ...
  forecastCheckbox.change(function onChange(event) {
    ...
    if (checked) {
      // Your code to show forecast information goes here
    } else {
      // Your code to hide forecast information goes here
    }
