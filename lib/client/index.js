...
// Testing 9 min purge instead of default 5
  client.resetRetroIfNeeded = function resetRetroIfNeeded () {
    if (client.retro.loadedMills > 0 && Date.now() - client.retro.loadedMills > times.mins(9).msecs) {
      resetRetro();
...
// Testing 1 min reload instead of default 3
    if (now - client.retro.loadedMills > times.mins(1).msecs) {
