...
_.forEach(recentData, function eachStatus (status) {
  ...
  openaps.updateVisualisation = function updateVisualisation (sbx) {
    ...
    // Check if the event is 'enacted' on time
...
// Check if the event is 'enacted' and within the last 1 minutes
...
// Check if the event is 'enacted' and within the last 2 minutes
