  ...
  openaps.updateVisualisation = function updateVisualisation (sbx) {
    ...
    function addSuggestion() {
      if (prop.lastSuggested) {
        ...
        reasonWithLineBreaks = reasonWithLineBreaks.replace(/AF:\s([0-9]\.[0-9]),/g, '<br>AF: $1<br>-----------------------<br><b>Algoritm slutsats:</b><br>');
...
var enactedReasonWithLineBreaks = prop.lastSuggested.reason.replace(/,/g, ' <br> • ');
 ...
 // Make "SMB INAKTIVERADE!" bold and add a line break
 enactedReasonWithLineBreaks = reasonWithLineBreaks.replace(/SMB INAKTIVERADE!/g, '<b>SMB INAKTIVERADE!</b><br> • ');

 // Make "Mikrobolus" bold and add a line break
 enactedReasonWithLineBreaks = reasonWithLineBreaks.replace(/Mikrobolus:/g, '<br><b>Mikrobolus:</b>');

 // Make "Microbolusing" bold and add a line break
 enactedReasonWithLineBreaks = reasonWithLineBreaks.replace(/Mikcobolusing/g, '<br><b>Mikrobolus:</b>');

 // Replace "E." with E+line break
 enactedReasonWithLineBreaks = reasonWithLineBreaks.replace(/E\. /g, 'E<br>  ');

 // Replace "U." with E+line break
 enactedReasonWithLineBreaks = reasonWithLineBreaks.replace(/U\. /g, 'E<br>  ');

 // Replace "; " with line breaks
 enactedReasonWithLineBreaks = reasonWithLineBreaks.replace(/;\s+(?!\w*;|&\w+;)/g, ' <br> • ');

 // Replace "AF: X.X," with the formatted string
 enactedReasonWithLineBreaks = reasonWithLineBreaks.replace(/AF:\s([0-9]\.[0-9]),/g, '<br>AF: $1<br>-----------------------<br><b>Algoritm slutsats:</b><br>');
