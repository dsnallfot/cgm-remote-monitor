...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
      reasonconf.push({ name: translate('Eating Soon'), targetTop: 4.4, targetBottom: 4.2, duration: 60 });
      reasonconf.push({ name: translate('Activity'), targetTop: 10, targetBottom: 9, duration: 120 });
      reasonconf.push({ name: translate('Efter dextro'), targetTop: 12, targetBottom: 10, duration: 45 });
    } else {
      reasonconf.push({ name: translate('Eating Soon'), targetTop: 80, targetBottom: 75, duration: 60 });
      reasonconf.push({ name: translate('Activity'), targetTop: 180, targetBottom: 160, duration: 120 });
      reasonconf.push({ name: translate('Efter dextro'), targetTop: 220, targetBottom: 180, duration: 45 });
    }
    return [
      {
