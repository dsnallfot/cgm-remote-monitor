...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
      reasonconf.push({ name: translate('Eating Soon'), targetTop: 4, targetBottom: 4, duration: 60 });
      reasonconf.push({ name: translate('Hög aktivitet 60min'), targetTop: 7.5, targetBottom: 7.5, duration: 60 });
      reasonconf.push({ name: translate('Hög aktivitet 120min'), targetTop: 7.5, targetBottom: 7.5, duration: 120 });
      reasonconf.push({ name: translate('Efter dextro'), targetTop: 7.5, targetBottom: 7.5, duration: 75 });
      reasonconf.push({ name: translate('Blocka SMB 8h'), targetTop: 6, targetBottom: 6, duration: 480 });
      reasonconf.push({ name: translate('Extra lågt insulinbehov'), targetTop: 9.5, targetBottom: 9.5, duration: 180 });
    } else {
      ...
      reasonconf.push({ name: translate('After dextro'), targetTop: 135, targetBottom: 135, duration: 75 });
    }
    return [
      {
