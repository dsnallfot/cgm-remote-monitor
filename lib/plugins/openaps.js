...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
      ...
      reasonconf.push({ name: translate('Activity'), targetTop: 9, targetBottom: 9, duration: 120 });
      reasonconf.push({ name: translate('Efter dextro'), targetTop: 10, targetBottom: 10, duration: 45 });
    } else {
      reasonconf.push({ name: translate('Eating Soon'), targetTop: 75, targetBottom: 75, duration: 60 });
      reasonconf.push({ name: translate('Activity'), targetTop: 160, targetBottom: 160, duration: 120 });
