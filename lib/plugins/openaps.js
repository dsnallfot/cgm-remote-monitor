...
var enactedReasonWithLineBreaks = prop.lastSuggested.reason.replace(/,/g, ' <br> • ');
 ...
 // Replace "AF: X.X" or "AF: X.XX" with the formatted string
 enactedReasonWithLineBreaks = enactedReasonWithLineBreaks.replace(/AF:\s([0-9]\.\d{1,2})/g, 'AF: $1<br>------------------------------<br><b>☑️ Algoritm beslut:</b>');
