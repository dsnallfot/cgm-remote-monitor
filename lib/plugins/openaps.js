...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
      ...
      reasonconf.push({ name: translate('Hög aktivitet'), targetTop: 8, targetBottom: 8, duration: 60 });
      reasonconf.push({ name: translate('Hög aktivitet länge'), targetTop: 8, targetBottom: 8, duration: 120 });
      reasonconf.push({ name: translate('Efter dextro'), targetTop: 8, targetBottom: 8, duration: 75 });
    } else {
      reasonconf.push({ name: translate('Eating Soon'), targetTop: 72, targetBottom: 72, duration: 60 });
      reasonconf.push({ name: translate('High Activity'), targetTop: 144, targetBottom: 144, duration: 60 });
      reasonconf.push({ name: translate('High Activity Prolonged'), targetTop: 144, targetBottom: 144, duration: 120 });
      reasonconf.push({ name: translate('Efter dextro'), targetTop: 144, targetBottom: 144, duration: 75 });
    }
    return [
      {
