  ...
  openaps.updateVisualisation = function updateVisualisation (sbx) {
    ...
    function addSuggestion() {
      if (prop.lastSuggested) {
        ...
        reasonWithLineBreaks = reasonWithLineBreaks.replace(/SMB INAKTIVERADE!/g, '<b>SMB INAKTIVERADE!</b> 🚫');
...
// ✅ Step 3: Continue with other replacements (won't affect AF/SMB placement)
enactedReasonWithLineBreaks = enactedReasonWithLineBreaks.replace(/SMB INAKTIVERADE!/g, '<b>SMB INAKTIVERADE!</b> 🚫');
enactedReasonWithLineBreaks = enactedReasonWithLineBreaks.replace(/Mikrobolus:/g, '<br>🔹 <b>Mikrobolus:</b>');
enactedReasonWithLineBreaks = enactedReasonWithLineBreaks.replace(/Microbolusing/g, '<br>🔹 <b>Mikrobolus:</b>');
