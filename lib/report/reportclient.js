...
if (params['targetLow']) {
  $('#rp_targetlow').val(params['targetLow']); // Set targetLow field
}

if (params['targetHigh']) {
  $('#rp_targethigh').val(params['targetHigh']); // Set targetHigh field
}
  ...
  $('#rp_optionsform').hide(); // Hide any form sections
    ...
    function show (event) {
      var options = {
        ...
        , targetLow: parseFloat($('#rp_targetlow').val().replace(',', '.')) // Get targetLow from field
        , targetHigh: parseFloat($('#rp_targethigh').val().replace(',', '.')) // Get targetHigh from field
        , openAps: $('#rp_optionsopenaps').is(':checked') // Handle openAps checkbox
      };
