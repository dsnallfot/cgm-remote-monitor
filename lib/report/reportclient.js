...
if (params['hideMenu'] === 'true') {
  ...
  $('#rp_optionsform').hide(); // Hide any form sections
    ...
    function show (event) {
      ...
      //Daniel: COmmented out during testingoptions.targetLow = parseFloat($('#rp_targetlow').val().replace(',', '.'));
      //Daniel: COmmented out during testing options.targetHigh = parseFloat($('#rp_targethigh').val().replace(',', '.'));
      options.raw = $('#rp_optionsraw').is(':checked');
      options.iob = $('#rp_optionsiob').is(':checked');
      options.cob = $('#rp_optionscob').is(':checked');
      //Daniel: COmmented out during testing options.openAps = $('#rp_optionsopenaps').is(':checked');
